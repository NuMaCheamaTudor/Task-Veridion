grouped_html = [
    ...
    ['afnanstore.shop.html', 'bersamaetawalin.site.html', 'cosekarang.com.html', 'dhavinastore.com.html', 'elitemajesty.com.html', 'juraganstore.shop.html', 'masjidrayaalfalah.id.html', 'parascerah.store.html', 'rakarta.com.html', 'susuetawalinkuid.site.html'],
    ['ampika.com.html'],
    ['cameliastore28.my.id.html'],
    ['coade.icu.html', 'imzcr.me.html'],
    ['dianessidewalkdeli.com.html'],
    ['dvnbysarah.com.html'],
    ['etawalinherbalmilk.site.html', 'tulangsendietawalin.site.html'],
    ['omerta-inc.com.html'],
    ['proapremium.id.html'],
]
